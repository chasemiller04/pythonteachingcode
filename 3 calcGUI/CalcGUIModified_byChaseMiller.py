...
class Calculator(Frame):
    ...
    def bind_buttons(self, master):
        ...
        master.bind("1", lambda event, char="Chase", btn=self.one_bttn: self.add_chr(char, btn))
    ...
    def create_widgets(self):
        ...
        self.one_bttn = Button(self, text="Chase", width=9, height=3,bg='LightBlue', fg='red', command=lambda: self.add_chr("Miller"))
